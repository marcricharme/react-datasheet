  ...
  _createClass(DataCell, [{
    ...
    value: function render() {
      var _props7 = this.props,
          ...
          classNameExtras = _props7.classNameExtras;
      ...
      var className = [cell.className, 'cell', cell.overflow, selected && 'selected', editing && 'editing', cell.readOnly && 'read-only', updated && 'updated', classNameExtras].filter(function (a) {
        return a;
      }).join(' ');
